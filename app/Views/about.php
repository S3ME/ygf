				...
				<div class="uk-container uk-light" style="background-color:rgba(4,1,51,0.6); border: 4px solid #fff; border-radius:20px;">
					<div class="uk-section-small">
						<div class="uk-text-center">
							<img class="uk-width-1-2 uk-width-1-3@m" src="images/logo.png" />
						</div>
						...
						<div class="uk-margin-large-top uk-grid-small uk-grid-divider uk-flex-center uk-child-width-auto" uk-grid>
							<div>
								<a href="https://ygf25.ygflive.com" target="_blank">YGF 25</a>
							</div>
							<div>
								<a href="https://ygf26.ygflive.com" target="_blank">YGF 26</a>
							</div>
							<div>
								<a href="https://ygf27.ygflive.com" target="_blank">YGF 27</a>
							</div>
							<div>
								<a href="https://ygf28.ygflive.com" target="_blank">YGF 28</a>
							</div>
						</div>
					</div>
				</div>
