    ...
    <body>
		<div class="partners-container" uk-height-viewport>
			...
			<section class="uk-section uk-padding-remove-bottom">
				<div class="uk-container uk-container-xlarge" style="background-color:rgba(255,255,255,0.6); border: 4px solid #fff; border-radius:20px;">
					<div class="uk-section-small">
						...
						<?php if ($ismobile) { ?>
							<img class="uk-width-1-1" src="images/partner-mobile.png" />
						<?php } else { ?>
							<img class="uk-width-1-1" src="images/partner-desktop.png" />
						<?php } ?>
					</div>
				</div>
			</section>
